  ...
  return (
    <footer className=" w-full bg-black flex justify-center opacity-90 px-4 overflow-hidden">
      <div className="mx-auto max-w-screen-xl w-full py-10 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 justify-items-center md:justify-items-normal text-white mt-[2.625rem]">
          <div>
          ...
          <div>
            ...
            <div className="flex gap-4 uppercase mt-[2.1875rem]">
              ...
              <a href="#" className="hover:text-[#d4b254] text-[0.8125rem]">
                <img src={instagramIcon} alt="facebook logo" className="h-4" />
              </a>
            </div>
          </div>
        </div>
